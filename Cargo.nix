...
in
{
  ...
  "registry+https://github.com/rust-lang/crates.io-index".base64urlsafedata."0.1.3" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.1.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "18b3d30abb74120a9d5267463b9e0045fdccc4dd152e7249d966612dc1721384"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".curve25519-dalek."4.0.0-pre.1" = overridableMkRustCrate (profileName: rec {
    ...
    version = "4.0.0-pre.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4033478fbf70d6acf2655ac70da91ee65852d69daf7a67bf7a2f518fb47aafcf"; };
    features = builtins.concatLists [
      [ "u64_backend" ]
    ];
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".deadpool-redis."0.12.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      redis = rustPackages."registry+https://github.com/rust-lang/crates.io-index".redis."0.23.0" { inherit profileName; };
      serde_1 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.164" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".derive-where."1.0.0-rc.3" = overridableMkRustCrate (profileName: rec {
    ...
    version = "1.0.0-rc.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "d322f2907b2abad3117790c1a54d8f2d64574ba0fbea54cb6c6e66a0e50d99a4"; };
    features = builtins.concatLists [
      [ "zeroize" ]
      [ "zeroize-on-drop" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".dhall."0.12.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      hex = rustPackages."registry+https://github.com/rust-lang/crates.io-index".hex."0.4.3" { inherit profileName; };
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "home" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".home."0.5.5" { inherit profileName; };
      itertools = rustPackages."registry+https://github.com/rust-lang/crates.io-index".itertools."0.10.5" { inherit profileName; };
    ...
    buildDependencies = {
      ...
      pest_generator = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".pest_generator."2.7.0" { profileName = "__noProfile"; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".educe."0.4.22" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.4.22";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "079044df30bb07de7d846d41a184c4b00e66ebdac93ee459253474f3a47e50ae"; };
    features = builtins.concatLists [
      [ "Clone" ]
      [ "Copy" ]
      [ "Debug" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".elsa."1.8.1" = overridableMkRustCrate (profileName: rec {
    ...
    version = "1.8.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b5e0aca8dce8856e420195bd13b6a64de3334235ccc9214e824b86b12bf26283"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".enum-ordinalize."3.1.13" = overridableMkRustCrate (profileName: rec {
    ...
    version = "3.1.13";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e4f76552f53cefc9a7f64987c3701b99d982f7690606fd67de1d09712fbf52f1"; };
    dependencies = {
      num_bigint = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num-bigint."0.4.3" { inherit profileName; };
      num_traits = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num-traits."0.2.15" { inherit profileName; };
      proc_macro2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.63" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".gloo."0.8.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      gloo_history = rustPackages."registry+https://github.com/rust-lang/crates.io-index".gloo-history."0.1.4" { inherit profileName; };
      gloo_net = rustPackages."registry+https://github.com/rust-lang/crates.io-index".gloo-net."0.3.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".gloo-history."0.1.4" = overridableMkRustCrate (profileName: rec {
    name = "gloo-history";
    version = "0.1.4";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "ddfd137a4b629e72b8c949ec56c71ea9bd5491cc66358a0a7787e94875feec71"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "query" ]
      [ "serde_urlencoded" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".gloo-net."0.2.6" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      gloo_utils = rustPackages."registry+https://github.com/rust-lang/crates.io-index".gloo-utils."0.1.7" { inherit profileName; };
      js_sys = rustPackages."registry+https://github.com/rust-lang/crates.io-index".js-sys."0.3.61" { inherit profileName; };
      pin_project = rustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-project."1.1.1" { inherit profileName; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.164" { inherit profileName; };
      serde_json = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.99" { inherit profileName; };
      thiserror = rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.40" { inherit profileName; };
      wasm_bindgen = rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen."0.2.84" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".gloo-net."0.3.0" = overridableMkRustCrate (profileName: rec {
    name = "gloo-net";
    version = "0.3.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "3000ef231a67d5bfee6b35f2c0f6f5c8d45b3381ef5bbbea603690ec4e539762"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "eventsource" ]
      [ "futures-channel" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".hashbrown."0.14.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      allocator_api2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".allocator-api2."0.2.15" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".markup5ever."0.7.5" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.7.5";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "897636f9850c3eef4905a5540683ed53dc9393860f0846cab2c2ddf9939862ff"; };
    dependencies = {
    ...
    buildDependencies = {
      ...
      serde = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.164" { profileName = "__noProfile"; };
      ...
      serde_json = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.99" { profileName = "__noProfile"; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".microformats."0.3.0" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.3.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "18e7fccd15cba21880e824d71b8354e9e67561c9cd2bf3ec09b21dba26392ecb"; };
    dependencies = {
      chrono = rustPackages."registry+https://github.com/rust-lang/crates.io-index".chrono."0.4.26" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".mutants."0.0.3" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.0.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "bc0287524726960e07b119cebd01678f852f147742ae0d925e6a520dca956126"; };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opaque-ke."2.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    version = "2.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "76d410412d23781909d90c3900c5783e830586765f2277bccc78167da8af81a5"; };
    features = builtins.concatLists [
      [ "argon2" ]
      [ "curve25519-dalek" ]
      [ "default" ]
    ...
    dependencies = {
      ...
      hmac = rustPackages."registry+https://github.com/rust-lang/crates.io-index".hmac."0.12.1" { inherit profileName; };
      rand = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rand."0.8.5" { inherit profileName; };
      serde_ = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.164" { inherit profileName; };
      subtle = rustPackages."registry+https://github.com/rust-lang/crates.io-index".subtle."2.5.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".pin-project."1.1.1" = overridableMkRustCrate (profileName: rec {
    name = "pin-project";
    version = "1.1.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "6e138fdd8263907a2b0e1b4e80b7e58c721126479b6e6eedfb1b402acea7b9bd"; };
    dependencies = {
      pin_project_internal = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-project-internal."1.1.1" { profileName = "__noProfile"; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".pin-project-internal."1.1.1" = overridableMkRustCrate (profileName: rec {
    name = "pin-project-internal";
    version = "1.1.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "d1fef411b303e3e12d534fb6e7852de82da56edd937d895125821fb7c09436c7"; };
    dependencies = {
      proc_macro2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.63" { inherit profileName; };
      quote = rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.29" { inherit profileName; };
      syn = rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."2.0.22" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".prokio."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      futures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.28" { inherit profileName; };
      ${ if hostPlatform.parsed.cpu.name == "wasm32" then "gloo" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".gloo."0.8.1" { inherit profileName; };
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "num_cpus" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num_cpus."1.16.0" { inherit profileName; };
      ...
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "tokio_stream" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio-stream."0.1.14" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".voprf."0.4.0-pre.3" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.4.0-pre.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "081acbe8fcf05d5e8e2aad8ef3d40e02eddeaec07c75a9770d862a0fc0874322"; };
    features = builtins.concatLists [
      [ "curve25519-dalek" ]
      [ "danger" ]
      [ "ristretto255" ]
