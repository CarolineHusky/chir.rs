...
in {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".axum."0.6.6" = overridableMkRustCrate (profileName: rec {
    name = "axum";
    version = "0.6.6";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo {
      inherit name version;
      sha256 = "4e246206a63c9830e118d12c894f56a82033da1a2361f5544deeee3df85c99d9";
    };
    features = builtins.concatLists [
      ["default"]
      ["form"]
    ...
    dependencies = {
      ...
      axum_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".axum-macros."0.3.4" {profileName = "__noProfile";};
  ...
  "registry+https://github.com/rust-lang/crates.io-index".axum-macros."0.3.4" = overridableMkRustCrate (profileName: rec {
    name = "axum-macros";
    version = "0.3.4";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo {
      inherit name version;
      sha256 = "5fbf955307ff8addb48d2399393c9e2740dd491537ec562b66ab364fc4a38841";
    };
    features = builtins.concatLists [
      ["default"]
    ];
  ...
  "unknown".chir-rs-auth."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      async_trait = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".async-trait."0.1.64" {profileName = "__noProfile";};
      axum = rustPackages."registry+https://github.com/rust-lang/crates.io-index".axum."0.6.6" {inherit profileName;};
      base64 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".base64."0.21.0" {inherit profileName;};
  ...
  "unknown".chir-rs-auth-web."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      zxcvbn = rustPackages."registry+https://github.com/rust-lang/crates.io-index".zxcvbn."2.2.1" {inherit profileName;};
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".deadpool-runtime."0.1.2" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      tokio_1 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.25.0" {inherit profileName;};
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".fancy-regex."0.8.0" = overridableMkRustCrate (profileName: rec {
    name = "fancy-regex";
    version = "0.8.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo {
      inherit name version;
      sha256 = "d95b4efe5be9104a4a18a9916e86654319895138be727b229820c39257c30dda";
    };
    features = builtins.concatLists [
      ["default"]
      ["perf"]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".markup5ever."0.7.5" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      ...
      serde_json = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.93" {profileName = "__noProfile";};
  ...
  "registry+https://github.com/rust-lang/crates.io-index".zxcvbn."2.2.1" = overridableMkRustCrate (profileName: rec {
    name = "zxcvbn";
    version = "2.2.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo {
      inherit name version;
      sha256 = "568becce91e872373a4b33f24ddc67e5280ae2536ccb8c9d22a25d398b72c8b0";
    };
    features = builtins.concatLists [
      ["builder"]
      ["default"]
    ...
    dependencies = {
      ...
      fancy_regex = rustPackages."registry+https://github.com/rust-lang/crates.io-index".fancy-regex."0.8.0" {inherit profileName;};
      itertools = rustPackages."registry+https://github.com/rust-lang/crates.io-index".itertools."0.10.5" {inherit profileName;};
      ${
        if hostPlatform.parsed.cpu.name == "wasm32"
        then "js_sys"
