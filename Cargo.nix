...
in
{
  ...
  "registry+https://github.com/rust-lang/crates.io-index".axum."0.6.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      axum_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".axum-core."0.3.0" { inherit profileName; };
      axum_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".axum-macros."0.3.0" { profileName = "__noProfile"; };
      ...
      tokio = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.24.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".combine."4.6.6" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      memchr = rustPackages."registry+https://github.com/rust-lang/crates.io-index".memchr."2.5.0" { inherit profileName; };
      pin_project_lite = rustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-project-lite."0.2.9" { inherit profileName; };
      tokio_dep = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.24.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".deadpool-redis."0.11.1" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.11.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "2b8bde44cbfdf17ae5baa45c9f43073b320f1a19955389315629304a23909ad2"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "rt_tokio_1" ]
      [ "serde" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".deadpool-runtime."0.1.2" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      tokio_1 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.24.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".dhall."0.12.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "home" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".home."0.5.4" { inherit profileName; };
      itertools = rustPackages."registry+https://github.com/rust-lang/crates.io-index".itertools."0.10.5" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".diesel."2.0.2" = overridableMkRustCrate (profileName: rec {
    ...
    version = "2.0.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "68c186a7418a2aac330bb76cde82f16c36b03a66fb91db32d20214311f9f6545"; };
    features = builtins.concatLists [
      [ "32-column-tables" ]
      [ "bitflags" ]
      [ "byteorder" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".diesel-async."0.2.0" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.2.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "5f9ff806825ea92f061cfca008f4885149a6c62b7f508d00d2c35c3d7522b946"; };
    features = builtins.concatLists [
      [ "deadpool" ]
      [ "default" ]
      [ "postgres" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".educe."0.4.20" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.4.20";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "cb0188e3c3ba8df5753894d54461f0e39bc91741dc5b22e1c46999ec2c71f4e4"; };
    features = builtins.concatLists [
      [ "Clone" ]
      [ "Copy" ]
      [ "Debug" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".enum-ordinalize."3.1.12" = overridableMkRustCrate (profileName: rec {
    ...
    version = "3.1.12";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a62bb1df8b45ecb7ffa78dca1c17a438fb193eb083db0b1b494d2a61bcb5096a"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".fiat-crypto."0.1.17" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.1.17";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a214f5bb88731d436478f3ae1f8a277b62124089ba9fb67f4f93fb100ef73c90"; };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".orion."0.17.3" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.17.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "f2baf7fd2e326e3895c681176788dd227fcd8369350e53c570592d8563fecbb6"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".pasetors."0.6.5" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.6.5";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "ed20c4c21d893414f42e0cbfebe8a8036b5ae9b0264611fb6504e395eda6ceec"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "ed25519-compact" ]
      [ "orion" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".pest_derive."2.5.1" = overridableMkRustCrate (profileName: rec {
    ...
    version = "2.5.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "cdc078600d06ff90d4ed238f0119d84ab5d43dbaad278b0e33a8820293b32344"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "std" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".pest_generator."2.5.1" = overridableMkRustCrate (profileName: rec {
    ...
    version = "2.5.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "28a1af60b1c4148bb269006a750cff8e2ea36aff34d2d96cf7be0b14d1bed23c"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "std" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".pest_meta."2.5.1" = overridableMkRustCrate (profileName: rec {
    ...
    version = "2.5.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "fec8605d59fc2ae0c6c1aefc0c7c7a9769732017c0ce07f7a9cfffa7b4404f20"; };
    dependencies = {
      once_cell = rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.17.0" { inherit profileName; };
      pest = rustPackages."registry+https://github.com/rust-lang/crates.io-index".pest."2.5.1" { inherit profileName; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".scoped-futures."0.1.2" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.1.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "655305227172f0178a34e02386c3b72e9c0d247a3b5087442540dbeb74c95c9a"; };
    features = builtins.concatLists [
      [ "std" ]
    ];
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".serde_dhall."0.12.0" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.12.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "8e1875f011ba1a37810617c9325b590a2539f44adae194578eafa681a276ec98"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tokio."1.24.0" = overridableMkRustCrate (profileName: rec {
    name = "tokio";
    version = "1.24.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "7125661431c26622a80ca5051a2f936c9a678318e0351007b0cc313143024e5c"; };
    features = builtins.concatLists [
      [ "bytes" ]
      [ "default" ]
      [ "io-std" ]
